...
class InvoiceItemRepositoryTest < Minitest::Test 
	...
	def setup
		...
		@invoice_item_repository = InvoiceItemRepository.new(invoice_items, sales_engine)
	end
	...
	def test_finds_by_unit_price
		results = invoice_item_repository.find_by_unit_price("29973")
	...
	def test_finds_by_missing_value_returns_an_empty_array
		results = invoice_item_repository.find_by_id("1000000")
	...
	def test_delegates_find_invoice_for_to_sales_engine
		sales_engine.expect(:find_invoice_by_invoice_item, [], ["1"])
